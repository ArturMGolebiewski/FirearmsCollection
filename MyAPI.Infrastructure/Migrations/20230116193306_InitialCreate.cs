        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YearOfFounding = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManufacturerName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FirearmModelName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Firearms_Manufacturer_ManufacturerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Firearms_ManufacturerId",
                table: "Firearms",
